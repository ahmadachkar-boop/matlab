...
%
% Instructions:
%   1. Make sure EEGLAB is initialized (run: eeglab nogui)
%   2. Edit the file path below to point to your EEG file
%   3. Run this script (press F5 or type: quickViewEEG)
%
...
%% Configuration
% Edit this path to your EEG file:
eegFile = 'path/to/your/file.mff';  % Change this!

% Or use file picker dialog:
% [file, path] = uigetfile({'*.mff;*.set;*.edf', 'EEG Files'}, 'Select EEG File');
...
try
    ...
    fprintf('\nTroubleshooting:\n');
    fprintf('  1. Check that the file path is correct\n');
    fprintf('  2. Make sure EEGLAB is properly installed\n');
    fprintf('  3. For .mff files, ensure mffimport plugin is installed\n');
end
